...
func initConfig() (err error) {
	...
	httpArgs.Rule = http.Flag("rule", "Advanced proxy rules, you can set the priority of the HTTP / SOCKS5 proxy rule, filter the source host, and filter the target URL using regular expressions.").Default("").Short('r').String()
	...
	socksArgs.Rule = socks.Flag("rule", "Advanced proxy rules, you can set the priority of the HTTP / SOCKS5 proxy rule, filter the source host, and filter the target URL using regular expressions.").Default("").Short('r').String()
